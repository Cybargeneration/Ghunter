...
stderr.writelines(f"""{Gr}
   ...
   ________  ______  ___________   __  ____  ___   __________________ 
  / ____/ / / / __ \/ ___/_  __/  / / / / / / / | / /_  __/ ____/ __ |
 / / __/ /_/ / / / /\__ \ / /    / /_/ / / / /  |/ / / / / __/ / /_/ /
...
if input_user == '1':  # OPSI 1
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}--------------------------------
   :@ @   :         {Wh}| {Gr}GHOST-HUNTER - IP ADDRESS {Wh}|
   : o    `.        {Wh}|       {Gr}@CODE BY CYBERGEN      {Wh}|
  :         ``.     {Wh}--------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    try:
        ...
        print(f" {Wh}[{Ye}!{Wh}] {Ye}PROGRAM ENDED...")
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   : @  @ :         {Wh}| {Gr}GHOST - HUNTER - PHONE NUMBER {Wh}|
   :   o  `.        {Wh}|        {Gr}@CODE BY CYBERGEN       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
:   :          ` . `.
 `.. :            `. ``;
    ...
    try:
        def phoneGW():
            User_phone = input(
                f"\n {Wh}Enter phone number target {Gr}Ex [+1443xxxxxxx] {Wh}: {Gr}")  # INPUT NUMBER PHONE
            default_region = "ID"  # DEFAULT INDONESIAN COUNTRY
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :@ @   :         {Wh}|  {Gr}GHOST-HUNTER -SHOW YOUR IP ADDRESS  {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY CYBERGEN       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    stderr.writelines(f"""{Wh}
     .-.
   .'   `.          {Wh}----------------------------------
   :@ @   :         {Wh}|    {Cy}GHOST-HUNTER USERNAME    {Wh}|
   : o    `.        {Wh}|        {Gr}@CODE BY CYBERGEN       {Wh}|
  :         ``.     {Wh}----------------------------------
 :             `.
:  :         .   `.
...
""")
    ...
    print(f"\n  {Wh}[{Ye}!{Wh}] {Ye}THANK'S FOR USING MY TOOL {Ye}GHOST-HUNTER !")
else:
